...
export default function ApplyForm({ jobs, defaultJobId }: ApplyFormProps) {
  ...
  const validate = () => {
    ...
    if (!cvFile) errors.cv_file = 'CV là bắt buộc'
    ...
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      <div className="flex-1 overflow-y-auto p-6 bg-[#fbf9f8]">
        <div className="max-w-[600px] mx-auto space-y-6">
          {/* Page Header */}
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Ứng tuyển ngay nào</h1>
            <p className="text-gray-500 mt-1">Hãy điền thông tin của bạn và gửi cho nhà tuyển dụng</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full pl-4 pr-10 py-3 border border-gray-300 rounded-lg text-base focus-visible:border-[#008b9c] focus-visible:ring-1 focus-visible:ring-[#008b9c] sm:text-sm appearance-none bg-white"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg text-base sm:text-sm placeholder-gray-400 focus-visible:border-[#008b9c] focus-visible:ring-1 focus-visible:ring-[#008b9c] ${formErrors.full_name ? 'border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg text-base sm:text-sm placeholder-gray-400 focus-visible:border-[#008b9c] focus-visible:ring-1 focus-visible:ring-[#008b9c] ${formErrors.email ? 'border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg text-base sm:text-sm placeholder-gray-400 focus-visible:border-[#008b9c] focus-visible:ring-1 focus-visible:ring-[#008b9c] ${formErrors.phone ? 'border-red-400 focus-visible:border-red-400 focus-visible:ring-red-400' : 'border-gray-300'}`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg text-base focus-visible:border-[#008b9c] focus-visible:ring-1 focus-visible:ring-[#008b9c] sm:text-sm placeholder-gray-400 resize-none"
              ...
              <div>
                ...
                >
                  <div className="space-y-2 text-center flex items-center justify-center gap-3">
                    <svg className={`group-hover:text-[#008b9c] ${formErrors.cv_file ? 'text-red-500' : 'text-gray-400'}`} aria-hidden="true" focusable="false" fill="none" height="20" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                      <polyline points="17 8 12 3 7 8"></polyline>
                      <line x1="12" x2="12" y1="3" y2="15"></line>
                    </svg>
                    <div className="flex text-sm text-gray-600">
                      <span>{fileName || 'Upload CV (pdf, docx, doc)'}</span>
                    </div>
                  </div>
                </label>
                <input
                ...
                <p id="cv_file-hint" className="text-xs text-gray-500 mt-1">PDF, DOC, DOCX - Tối đa 5MB</p>
              </div>
              ...
              <div className="pt-4 flex justify-center">
                <button
                  ...
                  className="w-full sm:w-auto min-w-[240px] flex justify-center items-center gap-2 py-3.5 px-8 border border-transparent rounded-lg shadow-sm text-base font-semibold text-white bg-[#008b9c] hover:bg-[#007a89] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#008b9c] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting && (
              ...
              <div className="text-center pt-2">
                <p className="text-sm text-gray-600">
                  Bạn cần hỗ trợ? <a className="font-medium text-gray-900 hover:text-[#008b9c] transition-colors" href="mailto:recruitment@fabbi.vn">Contact Us</a>
                </p>
              </div>
            </form>
          </div>
